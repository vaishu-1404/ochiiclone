...
function Navbar() {
 ...
 const menuOptions = [
   ...
   { text: "Achievements", path: "/achiev"},
   { text: "Insights", path: "/insights"},
   { text: "About Us", path: "/aboout"},
   { text: "Contact", path: "/contact"  }
 ];

  return (
    <div className=" fixed z-[999] w-full text-white px-20 py-8 font-['Neue Montreal']  ">
      ...
      <div className='menu-container lg:flex hidden'>
        <HiOutlineBars3 size={30} onClick={() => setOpenMenu(true)} />
      
      <Drawer open={openMenu} onClose={() => setOpenMenu(false)} anchor='right' className=' font-bold' >
        <Box
          sx={{ width: 500, bgcolor: '#09090b', color: '#f4f4f5', height:'100%',}}
      ...
      <div className='links flex lg:hidden gap-10 text-lg capitalize font-light '>
        <Link to='/service'>Services</Link>
        <Link to='/aboout'>About Us</Link>
        <Link to='/achiev'>Achievement</Link>
